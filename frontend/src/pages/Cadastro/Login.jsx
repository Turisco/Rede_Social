  ...
  return (
    <div className="cadastro-container">
      <form className="cadastro-form" onSubmit={handleSubmit}>
        ...
        <button className="cadastro-button" type="submit">Entrar</button>

        <button type="button" className="cadastro-link" onClick={() => navigate('/')}>Não tem conta? Cadastre-se</button>
      </form>
    </div>
  );
}
